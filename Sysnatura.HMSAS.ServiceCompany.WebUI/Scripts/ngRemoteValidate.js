                    ...
                    handleChange = function( value ) {
                        ...
                        request = $timeout( function( ) {
                            var calls = [],
                                ...
                                toValidate = { value: value, currentValue: attrs.dummy }, //modified by arun 19032016
                                httpOpts = { method: options.ngRemoteMethod };
                            //13052016
                            //=====================================================================
                            if (attrs.objectvalue === 'undefined' || attrs.objectvalue == null) {
                                toValidate = { value: value, currentValue: attrs.dummy }
                            } else {

                                toValidate = $.parseJSON(attrs.objectvalue);
                            }
                            //=======================================================================
