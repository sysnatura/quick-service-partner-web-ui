(function ()
{
    ...
    /** @ngInject */
    function ToolbarController($rootScope, $q,$http,$window, $state, $timeout, $mdSidenav, $translate, $mdToast, msNavigationService, localStorageService)
    {
        var vm = this;
         ...
         * Logout Function
         */
        //modified by:Anuja-03-08-2017
        //for Company User log out auidt trail
        function logout()
        {
            localStorageService.clearAll();
            $http.post($rootScope.url + "Account/CompanyUserLogOut?companyUserId=" + $rootScope.loggedInCompanyUser.cmpanyUsersDto.companyUsersId).then(function () {
        ...
        function changeLanguage(lang)
        {
            ...
            if ( lang.code !== 'en' )
            {
                var message = 'NETIZEN supports translations through angular-translate module, but currently we do not have any translations other than English language.';
