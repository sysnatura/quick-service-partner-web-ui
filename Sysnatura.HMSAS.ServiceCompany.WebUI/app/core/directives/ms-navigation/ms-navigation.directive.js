(function ()
{
    ...
    {
        var vm = this;
        vm.global =$rootScope.loggedInCompanyUser;
        ...
        vm.navigation.chatCount = null;     
        $scope.$on('CHAT_COUNT', function (event, args) {
            console.log('chat count updated to ' + args + ' on: ' + new Date().toLocaleTimeString());
            vm.navigation.chatCount = args;
